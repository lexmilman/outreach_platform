-- Sprint 4 hotfix — paste into Supabase SQL Editor and Run.
-- Mirrors supabase/migrations/00000000000015_sprint4.sql; safe to re-run.
...
-- Seed stock templates for the current user's org.
